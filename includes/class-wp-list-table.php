<?php
/**
 * Administration API: WP_List_Table_local class
 *
 * @package WordPress
...
class WP_List_Table_local {
	...
	public function ajax_user_can() {
		die( 'function WP_List_Table_local::ajax_user_can() must be overridden in a subclass.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 *
	 * @uses WP_List_Table_loca::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @abstract
	 */
	public function prepare_items() {
		die( 'function WP_List_Table_local::prepare_items() must be overridden in a subclass.' );
	}
...
<p class="search-box">
	...
	public function get_columns() {
		die( 'function WP_List_Table_loca::get_columns() must be overridden in a subclass.' );
	}
...
<table class="wp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	...
	/**
	 * Gets a list of CSS classes for the WP_List_Table_local table tag.
	 *
	 * @since 3.1.0
	 *
